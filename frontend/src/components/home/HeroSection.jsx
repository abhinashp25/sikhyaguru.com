...
const HeroSection = () => {
  return (
    <section>
      <div className="bg-gradient-to-br from-purple-950 via-black to-purple-700">
        <div className=" flex flex-col items-center px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 dark:text-gray-50">
          <h1 className="text-5xl font-bold leading-none sm:text-6xl xl:max-w-3xl text-gray-300">
          ...
          <div className="flex flex-wrap justify-center">
            ...
            <button
              type="button"
              className="px-8 py-3 m-2 text-lg border rounded dark:border-gray-300 text-gray-50"
            >
              Learn more
            </button>
          </div>
