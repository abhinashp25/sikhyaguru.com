...
const categories = [
  ...
  { icon: MonitorSmartphone, name: "Information Technology", colleges: "5205 Colleges" },
    ...
    <div className="min-h-screen bg-white p-6 md:p-12">
      <motion.div initial="hidden" animate="visible" variants={containerVariants} className="max-w-7xl mx-auto">
        <motion.div variants={itemVariants} className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Shikyaguru Finder</h1>
          <p className="text-xl text-gray-600 mb-8">Explore 25000+ Colleges, 200+ Exams & More</p>
          <p className="text-sm text-gray-500 mb-8">
            Reset your research strategy by browsing through our lists of top colleges, exams, courses and careers based
            ...
            <div className="inline-flex bg-gray-100 rounded-lg p-1">
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-all duration-200 ${
                  activeTab === "colleges" ? "bg-white text-gray-900 shadow-sm" : "text-gray-500 hover:text-gray-900"
                }`}
              >
                Colleges
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-all duration-200 ${
                  activeTab === "exams" ? "bg-white text-gray-900 shadow-sm" : "text-gray-500 hover:text-gray-900"
                }`}
              >
                Exams
              </button>
