...
const CompareColleges = () => {
  return (
    <section className="bg-slate-200 shadow-md text-gray-800 py-10 overflow-hidden">
      <div className="px-6 md:px-10">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6">
          {/* College 1 */}
          <div data-aos="fade-down-right" className="bg-slate-100 p-6 rounded-lg w-full md:w-1/3">
          ...
          {/* College 2 */}
          <div data-aos="fade-down-left" className="bg-slate-100 p-6 rounded-lg w-full md:w-1/3">
        ...
        {/* Comparison Table */}
        <div className="mt-8 bg-slate-100 p-6 rounded-lg overflow-x-auto">
        ...
        <div className="flex justify-center mt-6">
          <button className="bg-gradient-to-br from-blue-500  via-blue-950 to-blue-700 text-white px-6 py-3 rounded-md font-semibold hover:bg-purple-600">
