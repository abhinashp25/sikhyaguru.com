...
function CollegeList() {
  ...
  return (
    <div className="w-full px-6 md:px-10 py-6 bg-slate-100">
        ...
        <div className="flex flex-col lg:flex-row gap-6 ">
          ...
          <div className="flex-1">
                  ...
                  {collegeData.colleges.length != 0 ? (
                    collegeData.colleges.map((college, index) => (
                      ...
                      <div
                        ...
                        key={index}
                        className="bg-white cursor-pointer rounded-lg shadow-sm hover:shadow-lg transition-shadow"
                      >
            ...
            `}
                      ...
                      // <div
                      // onClick={() => navigate("/college")}
                      //  key={index} className="bg-white cursor-pointer rounded-lg shadow-md hover:shadow-lg transition-shadow">
                      //   <div className="p-6 ">
                      ...
                      //           className="bg-gradient-to-br from-blue-700   via-blue-950 to-blue-700 text-white px-6 py-2 rounded-lg hover:bg-slate-700 transition-colors">
                      //             View Details
                      //           </button>
                      //         </div>
                      //       </div>
